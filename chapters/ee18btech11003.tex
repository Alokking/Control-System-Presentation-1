...
\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{./figs/signal_flow.tex}}
	\end{center}
...
\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{./figs/P1.tex}}
	\end{center}
\caption{$P_1$}
\label{fig:sec_order}
\end{figure}
...
\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{./figs/P2.tex}}
	\end{center}
\caption{$P_2$}
\label{fig:sec_order}
\end{figure}
...
\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{./figs/L1.tex}}
	\end{center}
\caption{$L_1$}
\label{fig:sec_order}
\end{figure}
...
\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{./figs/L2.tex}}
	\end{center}
\caption{$L_2$}
\label{fig:sec_order}
\end{figure}
...
\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{./figs/L3.tex}}
	\end{center}
\caption{$L_3$}
\label{fig:sec_order}
\end{figure}
...
\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{./figs/L4.tex}}
	\end{center}
\caption{$L_4$}
\label{fig:sec_order}
\end{figure}
...
\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{./figs/D1_D3.tex}}
	\end{center}
\caption{$\Delta_1$}
\label{fig:sec_order}
\end{figure}
...
\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{./figs/D2_D4.tex}}
	\end{center}
\caption{$\Delta_2$}
\label{fig:sec_order}
\end{figure}
