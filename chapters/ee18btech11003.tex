...
\begin{figure}[!ht]
    \begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{./figs/ee18btech11003_block_diagram.tex}}
	\end{center}
...
\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{./figs/ee18btech11003_signal_flow.tex}}
	\end{center}
...
\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{./figs/ee18btech11003_P1.tex}}
	\end{center}
\caption{$P_1$}
\label{fig:sec_order}
\end{figure}
...
\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{./figs/ee18btech11003_P2.tex}}
	\end{center}
\caption{$P_2$}
\label{fig:sec_order}
\end{figure}
...
\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{./figs/ee18btech11003_L1.tex}}
	\end{center}
\caption{$L_1$}
\label{fig:sec_order}
\end{figure}
...
\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{./figs/ee18btech11003_L2.tex}}
	\end{center}
\caption{$L_2$}
\label{fig:sec_order}
\end{figure}
...
\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{./figs/ee18btech11003_L3.tex}}
	\end{center}
\caption{$L_3$}
\label{fig:sec_order}
\end{figure}
...
\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{./figs/ee18btech11003_L4.tex}}
	\end{center}
\caption{$L_4$}
\label{fig:sec_order}
\end{figure}
...
\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{./figs/ee18btech11003_table.tex}}
	\end{center}
\caption{Table}
\label{fig:sec_order}
\end{table}
...
\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{./figs/ee18btech11003_D1_D3.tex}}
	\end{center}
\caption{$\Delta_1$}
\label{fig:sec_order}
\end{figure}
...
\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{./figs/ee18btech11003_D2_D4.tex}}
	\end{center}
\caption{$\Delta_2$}
\label{fig:sec_order}
\end{figure}
